var skillset = {
  programming: {
      skillJS: {
        ...
        img_src: "../img/skills_images/js_logo.png",
      ...
      skillGrunt: {
        skill: "GruntJS",
        img_src: "../img/skills_images/grunt_logo.png",
      ...
      skillJava: {
        skill: "Java",
        img_src: "../img/skills_images/java_logo.png",
      ...
      skillNode: {
        ...
        img_src: "../img/skills_images/nodejs_logo.png",
      ...
      skillASP_MVC: {
        skill: "ASP.NET MVC",
        img_src: "../img/skills_images/asp_logo.png",
      ...
      skillInterests: {
        skill: "Other interests...",
        img_src: "../img/skills_images/other-interests_logo.png",
        desc: "I am also interested in learning GoLang for back-end functionality and Angular2 for front-end functionality. Other than web development specficically, I am interested in learning Ruby and Python, and possibly Rails for ruby specifically for web development."
      }
  },
  design: {
    skillHTML: {
      skill: "HTML",
      img_src: "../img/skills_images/html_logo.png",
    ...
    skillCSS: {
      skill: "CSS/SASS",
      img_src: "../img/skills_images/css_logo.png",
    ...
    skillBootstrap: {
      skill: "Bootstrap",
      img_src: "../img/skills_images/bootstrap_logo.png",
    ...
    skillResponsive: {
      ...
      img_src: "../img/skills_images/mobile_logo.png",
  ...
  communication: {
    skillTeamwork: {
      skill: "Teamwork",
      img_src: "../img/skills_images/teamwork_logo.png",
    ...
    skillQuestions: {
      ...
      img_src: "../img/skills_images/questionmark_logo.png",
    ...
    skillPlanning: {
      skill: "Planning",
      img_src: "../img/skills_images/planning_logo.png",
